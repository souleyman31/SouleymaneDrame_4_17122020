	...
	(o.fn = o.prototype = {
		...
		o.extend({
			...
			makeArray: function (a, b) {
				...
				return (
					null != a &&
						(s(Object(a)) ? o.merge(c, "string" == typeof a ? [a] : a) : f.call(c, a)),
					c
				);
			},
				...
				if (void 0 === a) {
					if (
						...
						while (c--) {
							(d = g[c].name),
								0 === d.indexOf("data-") &&
									((d = o.camelCase(d.slice(5))), P(f, d, e[d]));
						}
		...
		trigger: function (b, c, d, e) {
			...
			if (
				...
				if (!e && !n.noBubble && !o.isWindow(d)) {
					for (
						i = n.delegateType || q, X.test(i + q) || (g = g.parentNode);
						g;
						g = g.parentNode
					) {
						p.push(g), (h = g);
				...
				while ((f = h[b++]) && !a.isPropagationStopped()) {
					...
					while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped()) {
						(!a.namespace_re || a.namespace_re.test(g.namespace)) &&
							((a.handleObj = g),
							(a.data = g.data),
							(e = ((o.event.special[g.origType] || {}).handle || g.handler).apply(
								f.elem,
								i
							)),
							void 0 !== e &&
			...
			o.cssHooks[b] = {
				...
				set: function (a, c, d) {
					...
					return Gb(
						a,
						c,
						d ? Hb(a, b, d, "border-box" === o.css(a, "boxSizing", !1, e), e) : 0
					);
				}
			};
		}),
	...
	o.extend({
		...
		ajax: function (a, b) {
			...
			(i = k.global),
				...
				k.ifModified &&
					(o.lastModified[d] &&
						v.setRequestHeader("If-Modified-Since", o.lastModified[d]),
	...
	o.ajaxSetup({
		...
		o.ajaxPrefilter("json jsonp", function (b, c, d) {
			...
			return h || "jsonp" === b.dataTypes[0]
				? ((e = b.jsonpCallback = o.isFunction(b.jsonpCallback)
						? b.jsonpCallback()
						: b.jsonpCallback),
				  h
